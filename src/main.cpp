...
const string strMessageMagic = "CrimeCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight <= 50)
	nSubsidy = 1600 * COIN; // first 50 blocks are 1600 coin reward
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in CrimeCoin
    bool fStrictPayToScriptHash = true; // Always active in CrimeCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CrimeCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CrimeCoin Launch 15/02/15";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0x28bd2bf535a8707f9026f2eae48a4cb29e582f1203b86b050d3d70788e980f5b"));
